					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="row">
								<div class="col-lg-4">
									...
									<select class="form-control m-input custom-select custom-select-danger" name="tipoFecha" id="tipoFecha" onchange="">
								...
								<div class="col-lg-4">
									...
									<div class="input-group date">
										<input type="text" class="form-control m-input" id="m_datepicker_1" data-date-format="dd/mm/yyyy" value="<?php echo date('d/m/Y',strtotime(date('m/01/Y'))); ?>" />
								...
								<div class="col-lg-4">
									<label>Hasta</label>
									<div class="input-group date">
										<input type="text" class="form-control m-input" id="m_datepicker_2" data-date-format="dd/mm/yyyy" value="<?php echo date('d/m/Y',strtotime(date('m/30/Y'))); ?>" />
										<div class="input-group-append">
											<span class="input-group-text">
												<i class="la la-calendar-check-o"></i>
											</span>
						...
						<div class="col-lg-6">
							...
							<div class="row">
								<div class="col-lg-3">
									<label>Codigo</label>
									<input type="text" class="form-control m-input" name="codCliCon" id="codCliCon" disabled>
								</div>
								<div class="col-lg-7">
								...
								<div class="col-lg-1">
									...
									<span data-toggle="modal" data-target="#m_modal_2">
										...
										<!-- Agregar condicional "contrato" al CreaTablaContrato.php -->
									</span>
								</div>
							</div>
						</div>
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-3">
									...
									<select class="form-control m-input custom-select custom-select-danger" name="localidad" id="localidad" onchange="">
								...
								<div class="col-lg-2">
									...
									<input type="text" class="form-control m-input" name="numCom" id="numCom">
								</div>
								<div class="col-lg-1">
									<label>Tipo Nec.</label>
									<select class="form-control m-input custom-select custom-select-danger" name="tipoNec" id="tipoNec" onchange="">
										<option value="">Selecciona</option>
								...
								<div class="col-lg-3">
									...
									<select class="form-control m-input custom-select custom-select-danger" name="tipoServ" id="tipoServ" onchange="">
										<option value="">Selecciona</option>
										<?php
...
// include "modals/modalModificarContrato.php";
 ?>