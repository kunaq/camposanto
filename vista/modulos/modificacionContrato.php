						...
						<div class="tab-pane" id="m_tabs_2_10" role="tabpanel">
							<div class="row">
								...
								<div class="col-lg-1 offset-lg-6">
									...
									<button class="btn btnGuardarKqPst m-btn" type="button" data-toggle="m-tooltip" data-container="body" data-placement="top" title="" data-original-title="Añadir observación" onclick="masObsv('<?php echo $_SESSION['cod_usuario']; ?>');">
