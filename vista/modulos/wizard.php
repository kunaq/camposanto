											...
											<div class="row form-group">
												...
												<div class="col-lg-6">
													...
													<div class="input-group date">
														<input type="text" class="form-control form-control-sm m-input"  id="m_datepicker_1" data-date-format="dd/mm/yyyy" value="<?php echo date('d/m/Y', strtotime(date('d/m/Y').'+ 1 month')); ?>"/>
														<div class="input-group-append">
										...
										<div class="col-lg-12">
											<div class="row form-group">
												...
												<div class="col-lg-12">
													...
													<div class="input-group date">
														<input type="text" class="form-control form-control-sm m-input" id="m_datepicker_2_validate" data-date-format="dd/mm/yyyy" value="<?php echo date('d/m/Y',strtotime(date('d/m/Y').'+ 1 month')); ?>" />
														<div class="input-group-append">
															<span class="input-group-text">
																<i class="la la-calendar-check-o"></i>
															</span>
