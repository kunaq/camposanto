											...
											<div class="row form-group">
												...
												<div class="col-lg-6">
													...
													<div class="input-group date">
														<input type="text" class="form-control form-control-sm m-input"  id="m_datepicker_1" data-date-format="dd/mm/yyyy" value="<?php echo date('d/m/Y', strtotime(date('m/d/Y').'+ 1 month')); ?>"/>
														<div class="input-group-append">
