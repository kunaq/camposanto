<style type="text/css">
  .m-aside-menu .m-aside-menu--skin-light .m-menu__nav> .m-menu-item:not(.m-menu-item--parent):not(.m-menu-item--open):not(.m-menu-item--expanded):not(.m-menu-item--active):hover{ background: #DF0101 !important}
</style>
<!-- BEGIN: Left Aside -->
		...
		data-menu-vertical="true" m-menu-dropdown="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500"  style=" background-color: #DF0101;" 
		>	
					...
					<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true"  m-menu-submenu-toggle="hover">
						...
						<div class="m-menu__submenu ">
							...
							<ul class="m-menu__subnav" style="background:#DF0101;">
								...
								<li class="m-menu__item " aria-haspopup="true" >
									<a  href="registro-prospecto" class="m-menu__link ">
										<i class="m-menu__link-bullet m-menu__link-bullet--dot">
											<span></span>
										</i>
										<span class="m-menu__link-text">
