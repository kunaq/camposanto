											...
											<div class="col-lg-3">
												<p class="pull-right">
													<span data-toggle="modal" data-target="#m_modal_nvoConfigArbVen">
														<button type="button" disabled class="btn btn-sm btnGuardarKqPst" title="Nuevo" id="NvoConfArbVen" onclick="nvoRegistro();"  style="margin-right:6px;"><i class="fa fa-plus"></i></button>
													</span>	
