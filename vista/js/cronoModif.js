                        ...
                        for( li_i = 1; li_i < li_cuotas ; li_i ++){
                            ...
                            if( li_ctd_servicio <= 1 ){
                                ...
                                container3.querySelectorAll('tr').forEach(function (li_i){                     
                                    ...
                                    lde_saldo_detalle  = oCells.item(4).innerHTML.trim();
                                    console.log('lde_saldo_detalle',lde_saldo_detalle);
                                    lde_saldo_detalle = pasaAnumero(lde_saldo_detalle);
                                    lde_saldo_detalle = lde_saldo_detalle + lde_amortizacion;
                                    oCells.item(1).innerHTML = Number(lde_saldo_detalle).toLocaleString('en-US',{ style: 'decimal', maximumFractionDigits : 2, minimumFractionDigits : 2 });
