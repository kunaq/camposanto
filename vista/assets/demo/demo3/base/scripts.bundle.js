...
var mUtil = function() {
    ...
    return {
        init: function(t) {
            t && t.breakpoints && (a = t.breakpoints),
            n()
        },
            ...
            if (t && void 0 !== e) {
                ...
                if (t.classList)
                    for (var n = 0; n < a.length; n++)
                        a[n] && 0 < a[n].length && t.classList.add(mUtil.trim(a[n]));
        ...
        parents: function(t, e) {
            ...
            return function(t, e) {
                for (var a = document.querySelectorAll(e), n = t.parentNode; n && !o(a, n); )
                    n = n.parentNode;
                return n
            }(t, e)
        },
        ...
        data: function(a) {
            ...
            {
                set: function(t, e) {
                    void 0 === a.customDataTag && (mUtilElementDataStoreID++,
        ...
        scrollToViewport: function(t, e) {
            e || (e = 1200),
            zenscroll.intoView(t, e)
        },
        scrollToCenter: function(t, e) {
            e || (e = 1200),
            zenscroll.center(t, e)
        },
    ...
    g.fn.mDatatable = function(u) {
        if (0 !== g(this).length) {
            ...
            var f = {
                ...
                init: function(t) {
                    var e = !1;
                    return null === t.data.source && (f.extractTable(),
                    e = !0),
                    f.setupBaseDOM.call(),
                    f.setupDOM(p.table),
                    f.spinnerCallback(!0),
                    f.setDataSourceQuery(f.getOption("data.source.read.params.query")),
                    g(p).on("m-datatable--on-layout-updated", f.afterRender),
                    p.debug && f.stateRemove(f.stateId),
                    g.each(f.getOption("extensions"), function(t, e) {
                        "function" == typeof g.fn.mDatatable[t] && new g.fn.mDatatable[t](p,e)
                    }),
                    "remote" !== t.data.type && "local" !== t.data.type || ((!1 === t.data.saveState || !1 === t.data.saveState.cookie && !1 === t.data.saveState.webstorage) && f.stateRemove(f.stateId),
                    "local" === t.data.type && "object" == typeof t.data.source && (p.dataSet = p.originalDataSet = f.dataMapCallback(t.data.source)),
                    f.dataRender()),
                    e || (f.setHeadTitle(),
                    f.getOption("layout.footer") && f.setHeadTitle(p.tableFoot)),
                    void 0 !== t.layout.header && !1 === t.layout.header && g(p.table).find("thead").remove(),
                    void 0 !== t.layout.footer && !1 === t.layout.footer && g(p.table).find("tfoot").remove(),
                    null !== t.data.type && "local" !== t.data.type || (f.setupCellField.call(),
                    f.setupTemplateCell.call(),
                    f.setupSubDatatable.call(),
                    f.setupSystemColumn.call(),
                    f.redraw()),
                    g(window).resize(f.fullRender),
                    g(p).height(""),
                    g(f.getOption("search.input")).on("keyup", function(t) {
                ...
                extractTable: function() {
                    var i = []
                      , n = g(p).find("tr:first-child th").get().map(function(t, e) {
                        ...
                        for (var o in u.columns)
                            u.columns[o].field === a && (n = g.extend(!0, {}, u.columns[o], n));
                        return i.push(n),
                        a
                    });
                    u.columns = i;
                ...
                layoutUpdate: function() {
                    ...
                    f.setupSystemColumn.call(),
                    f.setupHover.call(),
                    void 0 === u.detail && 1 === f.getDepth() && f.lockTable.call(),
                    f.columnHide.call(),
                    f.resetScroll(),
                    f.isInit || (g(p).trigger("m-datatable--on-init", {
                        table: g(p.wrap).attr("id"),
                        options: u
                    }),
                    f.isInit = !0),
                    g(p).trigger("m-datatable--on-layout-updated", {
                        table: g(p.wrap).attr("id")
                    })
                },
                lockTable: function() {
                    var e = {
                        lockEnabled: !1,
                        init: function() {
                            e.lockEnabled = f.lockEnabledColumns(),
                        ...
                        enable: function() {
                            g(p.table).find("thead,tbody,tfoot").each(function() {
                                ...
                                0 === g(this).find(".m-datatable__lock").length && g(this).ready(function() {
                                    !function(t) {
                                        if (0 < g(t).find(".m-datatable__lock").length)
                                            f.log("Locked container already exist in: ", t);
                                            ...
                                            g(t).find(".m-datatable__row").each(function() {
                                                ...
                                                g(this).find(".m-datatable__cell").each(function() {
                                                    ...
                                                    void 0 !== t ? (void 0 === t.left && !0 !== t || g(this).appendTo(e),
                                                    void 0 !== t.right && g(this).appendTo(n)) : g(this).appendTo(a)
                                                }),
                                                g(this).remove()
                                            }),
                                            0 < e.lockEnabled.left.length && (g(p.wrap).addClass("m-datatable--lock"),
                                            g(o).appendTo(t)),
                                            (0 < e.lockEnabled.left.length || 0 < e.lockEnabled.right.length) && g(i).appendTo(t),
                                            0 < e.lockEnabled.right.length && (g(p.wrap).addClass("m-datatable--lock"),
                                            g(l).appendTo(t))
                                        } else
                                            f.log("No row exist in: ", t)
                                    }(t)
                                })
                            })
                        }
                ...
                fullRender: function() {
                    f.spinnerCallback(!0),
                    g(p.wrap).removeClass("m-datatable--loaded"),
                    f.insertData()
                },
                lockEnabledColumns: function() {
                    ...
                    return g.each(t, function(t, e) {
                        void 0 !== e.locked && (void 0 !== e.locked.left && mUtil.getBreakpoint(e.locked.left) <= a && n.left.push(e.locked.left),
                        void 0 !== e.locked.right && mUtil.getBreakpoint(e.locked.right) <= a && n.right.push(e.locked.right))
                    }),
                    n
                },
                afterRender: function(t, e) {
                    e.table == g(p.wrap).attr("id") && g(p).ready(function() {
                        f.isLocked() || (f.redraw(),
                        f.getOption("rows.autoHide") && (f.autoHide(),
                        g(p.table).find(".m-datatable__row").css("height", ""))),
                        g(p.tableBody).find(".m-datatable__row").removeClass("m-datatable__row--even"),
                        g(p.wrap).hasClass("m-datatable--subtable") ? g(p.tableBody).find(".m-datatable__row:not(.m-datatable__row-detail):even").addClass("m-datatable__row--even") : g(p.tableBody).find(".m-datatable__row:nth-child(even)").addClass("m-datatable__row--even"),
                        f.isLocked() && f.redraw(),
                        g(p.tableBody).css("visibility", ""),
                        g(p.wrap).addClass("m-datatable--loaded"),
                        f.scrollbar.call(),
                        f.sorting.call(),
                        f.spinnerCallback(!1)
                    })
                ...
                adjustLockContainer: function() {
                    ...
                    return g(p.table).find(".m-datatable__lock--scroll").css("width", n),
                    n
                },
                dragResize: function() {
                    ...
                    g(p.tableHead).find(".m-datatable__cell").mousedown(function(t) {
                        ...
                        i = t.pageX,
                        l = g(this).width(),
                        g(s).addClass("m-datatable__cell--resizing")
                        ...
                        g(s).removeClass("m-datatable__cell--resizing"),
                        r = !1
                    }),
                ...
                initHeight: function() {
                    if (u.layout.height && u.layout.scroll) {
                        ...
                        0 < t && (a -= t),
                        0 < e && (a -= e),
                        g(p.tableBody).css("max-height", a)
                    }
                },
                setupBaseDOM: function() {
                    p.initialDatatable = g(p).clone(),
                    "TABLE" === g(p).prop("tagName") ? (p.table = g(p).removeClass("m-datatable").addClass("m-datatable__table"),
                    0 === g(p.table).parents(".m-datatable").length && (p.table.wrap(g("<div/>").addClass("m-datatable").addClass("m-datatable--" + u.layout.theme)),
                    p.wrap = g(p.table).parent())) : (p.wrap = g(p).addClass("m-datatable").addClass("m-datatable--" + u.layout.theme),
                    p.table = g("<table/>").addClass("m-datatable__table").appendTo(p)),
                    void 0 !== u.layout.class && g(p.wrap).addClass(u.layout.class),
                    g(p.table).removeClass("m-datatable--destroyed").css("display", "block"),
                    void 0 === g(p).attr("id") && (f.setOption("data.saveState", !1),
                    g(p.table).attr("id", mUtil.getUniqueID("m-datatable--"))),
                    f.getOption("layout.minHeight") && g(p.table).css("min-height", f.getOption("layout.minHeight")),
                    f.getOption("layout.height") && g(p.table).css("max-height", f.getOption("layout.height")),
                    null === u.data.type && g(p.table).css("width", "").css("display", ""),
                    p.tableHead = g(p.table).find("thead"),
                    0 === g(p.tableHead).length && (p.tableHead = g("<thead/>").prependTo(p.table)),
                    p.tableBody = g(p.table).find("tbody"),
                    0 === g(p.tableBody).length && (p.tableBody = g("<tbody/>").appendTo(p.table)),
                    void 0 !== u.layout.footer && u.layout.footer && (p.tableFoot = g(p.table).find("tfoot"),
                    0 === g(p.tableFoot).length && (p.tableFoot = g("<tfoot/>").appendTo(p.table)))
                },
                    ...
                    g(t).find(".m-datatable__row").each(function(i, t) {
                        ...
                        g(t).find(".m-datatable__cell").each(function(t, a) {
                            ...
                            if (void 0 !== e && void 0 !== e.template) {
                                var n = "";
                                "string" == typeof e.template && (n = f.dataPlaceholder(e.template, l)),
                                "function" == typeof e.template && (n = e.template(l, i, p));
                                var o = document.createElement("span");
                                o.innerHTML = n,
                                g(a).html(o),
                                void 0 !== e.overflow && (g(o).css("overflow", e.overflow),
                    ...
                    0 !== p.dataSet.length) {
                            ...
                            g(e).find(".m-datatable__cell").each(function(t, a) {
                                ...
                                if (void 0 !== e) {
                                    ...
                                    if (void 0 !== e.selector && !1 !== e.selector) {
                                        if (0 < g(a).find('.m-checkbox [type="checkbox"]').length)
                                            return;
                                        ...
                                        void 0 !== e.selector.class && g(o).addClass(e.selector.class),
                                        g(a).children().html(o)
                                    }
                                    if (void 0 !== e.subtable && e.subtable) {
                                        if (0 < g(a).find(".m-datatable__toggle-subtable").length)
                                            return;
                        ...
                        var t = function(t) {
                            ...
                            if (void 0 !== e && void 0 !== e.selector && !1 !== e.selector) {
                                ...
                                void 0 !== e.selector.class && g(n).addClass(e.selector.class),
                                g(a).children().html(n)
                            }
                        };
                        u.layout.header && t(g(p.tableHead).find(".m-datatable__row").first()),
                        u.layout.footer && t(g(p.tableFoot).find(".m-datatable__row").first())
                    }
                },
                adjustCellsWidth: function() {
                    ...
                    if (0 < e) {
                        ...
                        o <= f.offset && (o = f.offset),
                        g(p.table).find(".m-datatable__row").find(".m-datatable__cell:visible").each(function(t, e) {
                            var a = o
                              , n = g(e).data("width");
                            void 0 !== n && (a = n),
                            g(e).children().css("width", parseInt(a))
                        })
                    }
                    return p
                },
                ...
                setupDOM: function(t) {
                    g(t).find("> thead").addClass("m-datatable__head"),
                    g(t).find("> tbody").addClass("m-datatable__body"),
                    g(t).find("> tfoot").addClass("m-datatable__foot"),
                    g(t).find("tr").addClass("m-datatable__row"),
                    g(t).find("tr > th, tr > td").addClass("m-datatable__cell"),
                    g(t).find("tr > th, tr > td").each(function(t, e) {
                    ...
                    var n = {
                        ...
                        init: function() {
                            ...
                            if (u.layout.scroll) {
                                ...
                                0 < g(e).find(".m-datatable__row").length && 0 < g(e).length ? (n.scrollHead = g(p.tableHead).find("> .m-datatable__lock--scroll > .m-datatable__row"),
                                n.scrollFoot = g(p.tableFoot).find("> .m-datatable__lock--scroll > .m-datatable__row"),
                                n.tableLocked = g(p.tableBody).find(".m-datatable__lock:not(.m-datatable__lock--scroll)"),
                                t > mUtil.getBreakpoint("lg") ? n.mCustomScrollbar(e) : n.defaultScrollbar(e)) : 0 < g(p.tableBody).find(".m-datatable__row").length && (n.scrollHead = g(p.tableHead).find("> .m-datatable__row"),
                                n.scrollFoot = g(p.tableFoot).find("> .m-datatable__row"),
                                t > mUtil.getBreakpoint("lg") ? n.mCustomScrollbar(p.tableBody) : n.defaultScrollbar(p.tableBody))
                            } else
                                g(p.table).css("overflow-x", "auto")
                        },
                        ...
                        onScrolling: function(t) {
                            var e = g(this).scrollLeft()
                              , a = g(this).scrollTop();
                            g(n.scrollHead).css("left", -e),
                            g(n.scrollFoot).css("left", -e),
                            g(n.tableLocked).each(function(t, e) {
                                g(e).css("top", -a)
                            })
                        },
                        mCustomScrollbar: function(t) {
                            ...
                            var a = g.extend({}, n.mcsOptions, {
                                ...
                                callbacks: {
                                    whileScrolling: function() {
                                        var a = this.mcs;
                                        g(n.scrollHead).css("left", a.left),
                                        g(n.scrollFoot).css("left", a.left),
                                        g(n.tableLocked).each(function(t, e) {
                                            g(e).css("top", a.top)
                                        }),
                                        clearTimeout(f.hoverTimer),
                            ...
                            !0 === f.getOption("layout.smoothScroll.scrollbarShown") && g(t).attr("data-scrollbar-shown", "true"),
                            f.mCustomScrollbar(t, a)
                        }
                    };
                    return n.init(),
                    n
                ...
                mCustomScrollbar: function(t, e) {
                    g(p.tableBody).css("overflow", ""),
                    f.destroyScroller(g(p.table).find(".mCustomScrollbar")),
                    g(t).mCustomScrollbar(e)
                },
                setHeadTitle: function(t) {
                    void 0 === t && (t = p.tableHead),
                    t = g(t)[0];
                    var e = u.columns
                      , o = t.getElementsByTagName("tr")[0]
                      , i = t.getElementsByTagName("td");
                    void 0 === o && (o = document.createElement("tr"),
                    t.appendChild(o)),
                    g.each(e, function(t, e) {
                        var a = i[t];
                        if (void 0 === a && (a = document.createElement("th"),
                        o.appendChild(a)),
                        void 0 !== e.title && (a.innerHTML = e.title,
                        a.setAttribute("data-field", e.field),
                        mUtil.addClass(a, e.class),
                        g(a).data(e)),
                        void 0 !== e.attr && g.each(e.attr, function(t, e) {
                            a.setAttribute(t, e)
                        }),
                        void 0 !== e.textAlign) {
                ...
                dataRender: function(t) {
                    ...
                    var n = function() {
                        ...
                        0 === t.perpage && (t.perpage = u.data.pageSize || 10),
                        t.total = p.dataSet.length;
                        var e = Math.max(t.perpage * (t.page - 1), 0)
                          , a = Math.min(e + t.perpage, t.total);
                        return p.dataSet = g(p.dataSet).slice(e, a),
                        t
                    }
                      , e = function(t) {
                        var e = function(e, a) {
                            g(e.pager).hasClass("m-datatable--paging-loaded") || (g(e.pager).remove(),
                            e.init(a)),
                            g(e.pager).off().on("m-datatable--on-goto-page", function(t) {
                                g(e.pager).remove(),
                                e.init(a)
                            });
                            ...
                            f.localDataUpdate(),
                            p.dataSet = g(p.dataSet).slice(t, n),
                            f.insertData()
                        };
                        if (g(p.wrap).removeClass("m-datatable--error"),
                        u.pagination)
                ...
                insertData: function() {
                    ...
                    if (g.each(p.dataSet, function(t, e) {
                        ...
                        g(a).data("obj", e),
                        void 0 !== d[t] && g.each(d[t], function() {
                            a.setAttribute(this.name, this.value)
                        });
                        for (var n = 0; n < m; n += 1) {
                            var o = u.columns[n]
                              , i = [];
                            if (f.getObject("sort.field", s) === o.field && i.push("m-datatable__cell--sorted"),
                            void 0 !== o.textAlign) {
                            ...
                            mUtil.addClass(r, i.join(" ")),
                            r.setAttribute("data-field", o.field),
                            r.innerHTML = f.getObject(o.field, e),
                            a.appendChild(r)
                        }
                        c.appendChild(a)
                    }),
                    0 === p.dataSet.length) {
                        ...
                        mUtil.addClass(n, "m-datatable--error"),
                        n.innerHTML = f.getOption("translate.records.noRecords"),
                        c.appendChild(n),
                        g(p.wrap).addClass("m-datatable--error m-datatable--loaded"),
                        f.spinnerCallback(!1)
                    }
                    g(p.tableBody).replaceWith(c),
                    p.tableBody = c,
                    f.setupDOM(p.table),
                    f.setupCellField([p.tableBody]),
                    f.setupTemplateCell(p.tableBody),
                    f.layoutUpdate()
                },
                updateTableComponents: function() {
                    p.tableHead = g(p.table).children("thead"),
                    p.tableBody = g(p.table).children("tbody"),
                    p.tableFoot = g(p.table).children("tfoot")
                },
                getData: function() {
                    f.spinnerCallback(!0);
                    var t = {
                    ...
                    if ("local" === u.data.type && (t.url = u.data.source),
                    "remote" === u.data.type) {
                        t.url = f.getOption("data.source.read.url"),
                        "string" != typeof t.url && (t.url = f.getOption("data.source.read")),
                        "string" != typeof t.url && (t.url = f.getOption("data.source")),
                        t.headers = f.getOption("data.source.read.headers"),
                        t.method = f.getOption("data.source.read.method") || "POST";
                        var e = f.getDataSourceParam();
                        f.getOption("data.serverPaging") || delete e.pagination,
                        f.getOption("data.serverSorting") || delete e.sort,
                        t.data = g.extend(!0, t.data, e, f.getOption("data.source.read.params"))
                    }
                    return g.ajax(t).done(function(t, e, a) {
                        p.lastResponse = t,
                        p.dataSet = p.originalDataSet = f.dataMapCallback(t),
                        f.setAutoColumns(),
                        g(p).trigger("m-datatable--on-ajax-done", [p.dataSet])
                    }).fail(function(t, e, a) {
                        f.destroyScroller(g(p.table).find(".mCustomScrollbar")),
                        g(p).trigger("m-datatable--on-ajax-fail", [t]),
                        g(p.tableBody).html(g("<span/>").addClass("m-datatable--error").html(f.getOption("translate.records.noRecords"))),
                        g(p.wrap).addClass("m-datatable--error m-datatable--loaded"),
                        f.spinnerCallback(!1)
                    }).always(function() {})
                },
                paging: function(t, e) {
                    var m = {
                        ...
                        init: function(t) {
                            m.meta = t,
                            m.meta.pages = Math.max(Math.ceil(m.meta.total / m.meta.perpage), 1),
                            m.meta.page > m.meta.pages && (m.meta.page = m.meta.pages),
                            m.paginateEvent = f.getTablePrefix(),
                            m.pager = g(p.table).siblings(".m-datatable__pager"),
                            g(m.pager).hasClass("m-datatable--paging-loaded") || (g(m.pager).remove(),
                            0 !== m.meta.pages && (f.setDataSourceParam("pagination", {
                                page: m.meta.page,
                                pages: m.meta.pages,
                                perpage: m.meta.perpage,
                                total: m.meta.total
                            }),
                            m.callback = m.serverCallback,
                            "function" == typeof e && (m.callback = e),
                            m.addPaginateEvent(),
                            m.populate(),
                            m.meta.page = Math.max(m.meta.page || 1, m.meta.page),
                            g(p).trigger(m.paginateEvent, m.meta),
                            m.pagingBreakpoint.call(),
                            g(window).resize(m.pagingBreakpoint)))
                        },
                        ...
                        populate: function() {
                            ...
                            m.pagerLayout.pagination = a,
                            g("<li/>").append(g("<a/>").attr("title", e.first).addClass("m-datatable__pager-link m-datatable__pager-link--first").append(g("<i/>").addClass(t.first)).on("click", m.gotoMorePage).attr("data-page", 1)).appendTo(a),
                            g("<li/>").append(g("<a/>").attr("title", e.prev).addClass("m-datatable__pager-link m-datatable__pager-link--prev").append(g("<i/>").addClass(t.prev)).on("click", m.gotoMorePage)).appendTo(a),
                            g("<li/>").append(g("<a/>").attr("title", e.more).addClass("m-datatable__pager-link m-datatable__pager-link--more-prev").html(g("<i/>").addClass(t.more)).on("click", m.gotoMorePage)).appendTo(a),
                            g("<li/>").append(g("<input/>").attr("type", "text").addClass("m-pager-input form-control").attr("title", e.input).on("keyup", function() {
                            ...
                            g("<li/>").append(g("<a/>").attr("title", e.more).addClass("m-datatable__pager-link m-datatable__pager-link--more-next").html(g("<i/>").addClass(t.more)).on("click", m.gotoMorePage)).appendTo(a),
                            g("<li/>").append(g("<a/>").attr("title", e.next).addClass("m-datatable__pager-link m-datatable__pager-link--next").append(g("<i/>").addClass(t.next)).on("click", m.gotoMorePage)).appendTo(a),
                            g("<li/>").append(g("<a/>").attr("title", e.last).addClass("m-datatable__pager-link m-datatable__pager-link--last").append(g("<i/>").addClass(t.last)).on("click", m.gotoMorePage).attr("data-page", m.meta.pages)).appendTo(a),
                            f.getOption("toolbar.items.info") && (m.pagerLayout.info = g("<div/>").addClass("m-datatable__pager-info").append(g("<span/>").addClass("m-datatable__pager-detail"))),
                            g.each(f.getOption("toolbar.layout"), function(t, e) {
                            ...
                            0 == d.length && (d = [10, 20, 30, 50, 100]),
                            g.each(d, function(t, e) {
                                var a = e;
                                -1 === e && (a = "All"),
                                g("<option/>").attr("value", e).html(a).appendTo(s)
                            }),
                            g(p).ready(function() {
                        ...
                        paste: function() {
                            g.each(g.unique(f.getOption("toolbar.placement")), function(t, e) {
                                "bottom" === e && g(m.pager).clone(!0).insertAfter(p.table),
                                "top" === e && g(m.pager).clone(!0).addClass("m-datatable__pager--top").insertBefore(p.table)
                            })
                        },
                        gotoMorePage: function(t) {
                            if (t.preventDefault(),
                            "disabled" === g(this).attr("disabled"))
                                return !1;
                            var e = g(this).attr("data-page");
                            return void 0 === e && (e = g(t.target).attr("data-page")),
                            m.openPage(parseInt(e)),
                            !1
                        },
                        gotoPage: function(t) {
                            t.preventDefault(),
                            g(this).hasClass("m-datatable__pager-link--active") || m.openPage(parseInt(g(this).data("page")))
                        },
                        openPage: function(t) {
                            m.meta.page = parseInt(t),
                            g(p).trigger(m.paginateEvent, m.meta),
                            m.callback(m, m.meta),
                            g(m.pager).trigger("m-datatable--on-goto-page", m.meta)
                        },
                        updatePerpage: function(t) {
                            t.preventDefault(),
                            null === f.getOption("layout.height") && g("html, body").animate({
                                scrollTop: g(p).position().top
                            }),
                            m.pager = g(p.table).siblings(".m-datatable__pager").removeClass("m-datatable--paging-loaded"),
                            t.originalEvent && (m.meta.perpage = parseInt(g(this).val())),
                            g(m.pager).find("select.m-datatable__pager-size").val(m.meta.perpage).attr("data-selected", m.meta.perpage),
                            f.setDataSourceParam("pagination", {
                                page: m.meta.page,
                                pages: m.meta.pages,
                                perpage: m.meta.perpage,
                                total: m.meta.total
                            }),
                            g(m.pager).trigger("m-datatable--on-update-perpage", m.meta),
                            g(p).trigger(m.paginateEvent, m.meta),
                            m.callback(m, m.meta),
                            m.updateInfo.call()
                        },
                        addPaginateEvent: function(t) {
                            g(p).off(m.paginateEvent).on(m.paginateEvent, function(t, e) {
                                ...
                                g(a).find(".m-datatable__pager-link--active").removeClass("m-datatable__pager-link--active"),
                                g(a).find('.m-datatable__pager-link-number[data-page="' + e.page + '"]').addClass("m-datatable__pager-link--active"),
                                g(a).find(".m-datatable__pager-link--prev").attr("data-page", Math.max(e.page - 1, 1)),
                                g(a).find(".m-datatable__pager-link--next").attr("data-page", Math.min(e.page + 1, e.pages)),
                                g(m.pager).each(function() {
                                    g(this).find('.m-pager-input[type="text"]').prop("value", e.page)
                                }),
                                g(m.pager).find(".m-datatable__pager-nav").show(),
                                e.pages <= 1 && g(m.pager).find(".m-datatable__pager-nav").hide(),
                                f.setDataSourceParam("pagination", {
                                    page: m.meta.page,
                                    pages: m.meta.pages,
                                    perpage: m.meta.perpage,
                                ...
                                g(m.pager).find("select.m-datatable__pager-size").val(e.perpage).attr("data-selected", e.perpage),
                                g(p.table).find('.m-checkbox > [type="checkbox"]').prop("checked", !1),
                                g(p.table).find(".m-datatable__row--active").removeClass("m-datatable__row--active"),
                                m.updateInfo.call(),
                                m.pagingBreakpoint.call()
                            })
                        },
                        ...
                        pagingBreakpoint: function() {
                            ...
                            if (0 !== g(a).length) {
                                ...
                                g(a).find("li").show(),
                                g.each(f.getOption("toolbar.items.pagination.pages"), function(t, e) {
                                    if (mUtil.isInResponsiveRange(t)) {
                                        switch (t) {
                                        case "desktop":
                                        case "tablet":
                                            Math.ceil(n / e.pagesNumber),
                                            e.pagesNumber,
                                            e.pagesNumber;
                                            g(o).hide(),
                                            m.meta = f.getDataSourceParam("pagination"),
                                            m.paginationUpdate();
                                            break;
                                        case "mobile":
                                            g(o).show(),
                                            g(a).find(".m-datatable__pager-link--more-prev").closest("li").hide(),
                        ...
                        paginationUpdate: function() {
                            ...
                            d === m.meta.pages && d === g(r).last().data("page") ? g(a).parent().hide() : g(a).parent().show(),
                            1 === m.meta.page ? (g(n).attr("disabled", !0).addClass("m-datatable__pager-link--disabled"),
                            g(o).attr("disabled", !0).addClass("m-datatable__pager-link--disabled")) : (g(n).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"),
                            g(o).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled")),
                            m.meta.page === m.meta.pages ? (g(i).attr("disabled", !0).addClass("m-datatable__pager-link--disabled"),
                            g(l).attr("disabled", !0).addClass("m-datatable__pager-link--disabled")) : (g(i).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"),
                            g(l).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"));
                ...
                columnHide: function() {
                    ...
                    g.each(u.columns, function(t, e) {
                        if (void 0 !== e.responsive) {
                            ...
                            mUtil.getBreakpoint(e.responsive.hidden) >= o ? g(n).hide() : g(n).show(),
                            mUtil.getBreakpoint(e.responsive.visible) <= o ? g(n).show() : g(n).hide()
                        }
                    })
                },
                setupSubDatatable: function() {
                    ...
                    if ("function" == typeof l && !(0 < g(p.table).find(".m-datatable__subtable").length)) {
                        g(p.wrap).addClass("m-datatable--subtable"),
                        u.columns[0].subtable = !0;
                        var o = function(a) {
                            a.preventDefault();
                            var t = g(this).closest(".m-datatable__row")
                              , e = g(t).next(".m-datatable__row-subtable");
                            0 === g(e).length && (e = g("<tr/>").addClass("m-datatable__row-subtable m-datatable__row-loading").hide().append(g("<td/>").addClass("m-datatable__subtable").attr("colspan", f.getTotalColumns())),
                            g(t).after(e),
                            g(t).hasClass("m-datatable__row--even") && g(e).addClass("m-datatable__row-subtable--even")),
                            g(e).toggle();
                            ...
                            g(t).hasClass("m-datatable__row--subtable-expanded") ? (g(i).addClass(f.getOption("layout.icons.rowDetail.collapse")),
                            g(t).removeClass("m-datatable__row--subtable-expanded"),
                            g(p).trigger("m-datatable--on-collapse-subtable", [t])) : (g(i).addClass(f.getOption("layout.icons.rowDetail.expand")),
                            g(t).addClass("m-datatable__row--subtable-expanded"),
                            g(p).trigger("m-datatable--on-expand-subtable", [t])),
                            0 === g(n).find(".m-datatable").length && (g.map(p.dataSet, function(t, e) {
                                return o === t[u.columns[0].field] && (a.data = t,
                                !0)
                            }),
                            a.detailCell = n,
                            a.parentRow = t,
                            a.subTable = n,
                            l(a),
                            g(n).children(".m-datatable").on("m-datatable--on-init", function(t) {
                ...
                dataMapCallback: function(t) {
                    var e = t;
                    return "function" == typeof f.getOption("data.source.read.map") ? f.getOption("data.source.read.map")(t) : (void 0 !== t && void 0 !== t.data && (e = t.data),
                    e)
                },
                isSpinning: !1,
                spinnerCallback: function(t) {
                    if (t) {
                        if (!f.isSpinning) {
                            ...
                            !0 === e.message && (e.message = f.getOption("translate.records.processing")),
                            f.isSpinning = !0,
                            void 0 !== mApp && mApp.block(p, e)
                        }
                    } else
                        f.isSpinning = !1,
                        void 0 !== mApp && mApp.unblock(p)
                },
                sortCallback: function(t, i, e) {
                    ...
                    return g(t).sort(function(t, e) {
                        ...
                        case "number":
                            return isNaN(parseFloat(a)) && null != a && (a = Number(a.replace(/[^0-9\.-]+/g, ""))),
                            isNaN(parseFloat(n)) && null != n && (n = Number(n.replace(/[^0-9\.-]+/g, ""))),
                            a = parseFloat(a),
                            n = parseFloat(n),
                            "asc" === i ? n < a ? 1 : a < n ? -1 : 0 : a < n ? 1 : n < a ? -1 : 0;
                        case "string":
                        default:
                ...
                log: function(t, e) {
                    void 0 === e && (e = ""),
                    p.debug && console.log(t, e)
                },
                autoHide: function() {
                    g(p.table).find(".m-datatable__cell").show(),
                    g(p.tableBody).each(function() {
                        for (; g(this)[0].offsetWidth < g(this)[0].scrollWidth; )
                            g(p.table).find(".m-datatable__row").each(function(t) {
                    ...
                    var t = function(t) {
                        ...
                        var e = g(this).closest(".m-datatable__row")
                          , a = g(e).next();
                        if (g(a).hasClass("m-datatable__row-detail"))
                            g(this).find("i").removeClass(f.getOption("layout.icons.rowDetail.expand")).addClass(f.getOption("layout.icons.rowDetail.collapse")),
                            g(a).remove();
                        else {
                    ...
                    g(p.tableBody).find(".m-datatable__row").each(function() {
                        g(this).prepend(g("<td/>").addClass("m-datatable__cell m-datatable__toggle--detail").append(g("<a/>").addClass("m-datatable__toggle-detail").attr("href", "#").on("click", t).append(g("<i/>").css("width", "21px").addClass(f.getOption("layout.icons.rowDetail.collapse"))))),
                        0 === g(p.tableHead).find(".m-datatable__toggle-detail").length ? (g(p.tableHead).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>'),
                        g(p.tableFoot).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>')) : g(p.tableHead).find(".m-datatable__toggle-detail").find("span").css("width", "21px")
                    })
                },
                hoverColumn: function() {
                    g(p.tableBody).on("mouseenter", ".m-datatable__cell", function() {
                        var t = g(f.cell(this).nodes()).index();
                        g(f.cells().nodes()).removeClass("m-datatable__cell--hover"),
                        g(f.column(t).nodes()).addClass("m-datatable__cell--hover")
                    })
                },
                setAutoColumns: function() {
                    ...
                    g(p.tableHead).find(".m-datatable__row").remove(),
                    f.setHeadTitle(),
                    f.getOption("layout.footer") && (g(p.tableFoot).find(".m-datatable__row").remove(),
                    f.setHeadTitle(p.tableFoot)))
                },
                isLocked: function() {
                ...
                replaceTableContent: function(t, e) {
                    ...
                    g(e).hasClass("mCustomScrollbar") ? g(e).find(".mCSB_container").html(t) : g(e).html(t)
                },
                ...
                getTableId: function(t) {
                    void 0 === t && (t = "");
                    var e = g(p).attr("id");
                    return void 0 === e && (e = g(p).attr("class").split(" ")[0]),
                    e + t
                },
                getTablePrefix: function(t) {
                    return void 0 !== t && (t = "-" + t),
                    f.getTableId() + "-" + f.getDepth() + t
                },
                getDepth: function() {
                    for (var t = 0, e = p.table; e = g(e).parents(".m-datatable__table"),
                    t++,
                    0 < g(e).length; )
                        ;
                    return t
                ...
                stateKeep: function(t, e) {
                    t = f.getTablePrefix(t),
                    !1 !== f.getOption("data.saveState") && (f.getOption("data.saveState.webstorage") && localStorage && localStorage.setItem(t, JSON.stringify(e)),
                    f.getOption("data.saveState.cookie") && Cookies.set(t, JSON.stringify(e)))
                },
                stateGet: function(t, e) {
                    if (t = f.getTablePrefix(t),
                    !1 !== f.getOption("data.saveState")) {
                        var a = null;
                ...
                getTotalColumns: function(t) {
                    return void 0 === t && (t = p.tableBody),
                    g(t).find(".m-datatable__row").first().find(".m-datatable__cell").length
                },
                getOneRow: function(t, e, a) {
                    void 0 === a && (a = !0);
                    var n = g(t).find(".m-datatable__row:not(.m-datatable__row-detail):nth-child(" + e + ")");
                    return a && (n = n.find(".m-datatable__cell")),
                    n
                },
                ...
                sortColumn: function(t, o, i) {
                    ...
                    var l = g(t).index()
                      ...
                      , a = g(t).closest(".m-datatable__lock").index();
                    -1 !== a && (e = g(p.tableBody).find(".m-datatable__lock:nth-child(" + (a + 1) + ")").find(".m-datatable__row"));
                    var n = g(e).parent();
                    g(e).sort(function(t, e) {
                        var a = g(t).find("td:nth-child(" + l + ")").text()
                          , n = g(e).find("td:nth-child(" + l + ")").text();
                        return i && (a = parseInt(a),
                        n = parseInt(n)),
                        "asc" === o ? n < a ? 1 : a < n ? -1 : 0 : a < n ? 1 : n < a ? -1 : 0
                    }).appendTo(n)
                },
                sorting: function() {
                    var i = {
                        init: function() {
                            u.sortable && (g(p.tableHead).find(".m-datatable__cell:not(.m-datatable__cell--check)").addClass("m-datatable__cell--sort").off("click").on("click", i.sortClick),
                            i.setIcon())
                        },
                        setIcon: function() {
                        ...
                        sortClick: function(t) {
                            ...
                            if ((void 0 === n.sortable || !1 !== n.sortable) && (g(p.tableHead).find(".m-datatable__cell > span > i").remove(),
                            u.sortable)) {
                                f.spinnerCallback(!0);
                                var o = "desc";
                                f.getObject("field", e) === a && (o = f.getObject("sort", e)),
                                e = {
                                    field: a,
                                    sort: o = void 0 === o || "desc" === o ? "asc" : "desc"
                                },
                                f.setDataSourceParam("sort", e),
                                i.setIcon(),
                                setTimeout(function() {
                                    f.dataRender("sort"),
                                    g(p).trigger("m-datatable--on-sort", e)
                                }, 300)
                            }
                        }
                    };
                ...
                localDataUpdate: function() {
                    ...
                    if (void 0 !== n && !0 !== f.getOption("data.serverSorting") ? "function" == typeof n.sortCallback ? p.dataSet = n.sortCallback(p.originalDataSet, e, n) : p.dataSet = f.sortCallback(p.originalDataSet, e, n) : p.dataSet = p.originalDataSet,
                    "object" == typeof a.query && !f.getOption("data.serverFiltering")) {
                        a.query = a.query || {};
                        var o = function(t) {
                            for (var e in t)
                                if (t.hasOwnProperty(e))
                                    if ("string" == typeof t[e]) {
                                        if (t[e].toLowerCase() == i || -1 !== t[e].toLowerCase().indexOf(i))
                                            return !0
                        ...
                        void 0 !== i && "" !== i && (i = i.toLowerCase(),
                        p.dataSet = g.grep(p.dataSet, o),
                        delete a.query[f.getGeneralSearchKey()]),
                        g.each(a.query, function(t, e) {
                            "" === e && delete a.query[t]
                        }),
                        p.dataSet = f.filterArray(p.dataSet, a.query),
                        p.dataSet = p.dataSet.filter(function() {
                            return !0
                        })
                    }
                    return p.dataSet
                ...
                resetScroll: function() {
                    void 0 === u.detail && 1 === f.getDepth() && (g(p.table).find(".m-datatable__row").css("left", 0),
                    g(p.table).find(".m-datatable__lock").css("top", 0),
                    g(p.tableBody).scrollTop(0))
                },
                ...
                getDefaultSortColumn: function() {
                    var a;
                    return g.each(u.columns, function(t, e) {
                        if (void 0 !== e.sortable && -1 !== g.inArray(e.sortable, ["asc", "desc"]))
                            return !(a = {
                                sort: e.sortable,
                                field: e.field
                            })
                ...
                getHiddenDimensions: function(t, e) {
                    ...
                    a.width = g(t).width(),
                    a.outerWidth = g(t).outerWidth(e),
                    a.innerWidth = g(t).innerWidth(),
                    a.height = g(t).height(),
                    a.innerHeight = g(t).innerHeight(),
                    a.outerHeight = g(t).outerHeight(e),
                    o.each(function(t) {
                        var e = i[t];
                        for (var a in n)
                            this.style[a] = e[a]
                ...
                extendObj: function(t, e, n) {
                    ...
                    return function t(e) {
                        var a = o[i++];
                        void 0 !== e[a] && null !== e[a] ? "object" != typeof e[a] && "function" != typeof e[a] && (e[a] = {}) : e[a] = {},
                ...
                timer: 0,
                redraw: function() {
                    return f.adjustCellsWidth.call(),
                    f.isLocked() && (f.scrollbar(),
                    f.resetScroll(),
                    f.adjustCellsHeight.call()),
                    f.adjustLockContainer.call(),
                    f.initHeight.call(),
                    p
                },
                load: function() {
                ...
                reload: function() {
                    return function(t, e) {
                        ...
                        f.timer = setTimeout(t, e)
                    }(function() {
                        u.data.serverFiltering || f.localDataUpdate(),
                        f.dataRender(),
                        g(p).trigger("m-datatable--on-reloaded")
                    }, f.getOption("search.delay")),
                    p
                },
                getRecord: function(n) {
                    return void 0 === p.tableBody && (p.tableBody = g(p.table).children("tbody")),
                    g(p.tableBody).find(".m-datatable__cell:first-child").each(function(t, e) {
                        if (n == g(e).text()) {
                            var a = g(e).closest(".m-datatable__row").index() + 1;
                            return p.API.record = p.API.value = f.getOneRow(p.tableBody, a),
                            p
                        }
                    }),
                    p
                ...
                getColumn: function(t) {
                    return f.setSelectedRecords(),
                    p.API.value = g(p.API.record).find('[data-field="' + t + '"]'),
                    p
                },
                destroy: function() {
                    g(p).parent().find(".m-datatable__pager").remove();
                    var t = g(p.initialDatatable).addClass("m-datatable--destroyed").show();
                    return g(p).replaceWith(t),
                    g(p = t).trigger("m-datatable--on-destroy"),
                    f.isInit = !1,
                    t = null
                },
                sort: function(t, e) {
                    ...
                    return f.setDataSourceParam("sort", a),
                    setTimeout(function() {
                        f.dataRender("sort"),
                        g(p).trigger("m-datatable--on-sort", a),
                        g(p.tableHead).find(".m-datatable__cell > span > i").remove()
                    }, 300),
                    p
                },
                getValue: function() {
                ...
                setActive: function(t) {
                    "string" == typeof t && (t = g(p.tableBody).find('.m-checkbox--single > [type="checkbox"][value="' + t + '"]')),
                    g(t).prop("checked", !0);
                ...
                setSelectedRecords: function() {
                    return p.API.record = g(p.tableBody).find(".m-datatable__row--active"),
                    p
                },
                getSelectedRecords: function() {
                    return f.setSelectedRecords(),
                    p.API.record = p.rows(".m-datatable__row--active").nodes(),
                    p.API.record
                },
                ...
                search: function(n, e) {
                    ...
                    t = function() {
                        ...
                        f.setDataSourceQuery(a),
                        u.data.serverFiltering || f.localDataUpdate(),
                        f.dataRender("search")
                    }
                    ,
                    a = f.getOption("search.delay"),
                    clearTimeout(f.timer),
                    f.timer = setTimeout(t, a);
                    var t, a
                },
                setDataSourceParam: function(t, e) {
                    p.API.params = g.extend({}, {
                        ...
                        query: {}
                    }, p.API.params, f.stateGet(f.stateId)),
                    p.API.params = f.extendObj(p.API.params, t, e),
                    f.stateKeep(f.stateId, p.API.params)
                },
                getDataSourceParam: function(t) {
                    ...
                    "string" == typeof t ? f.getObject(t, p.API.params) : p.API.params
                },
                ...
                showColumn: function(a) {
                    g.map(u.columns, function(t) {
                        return a === t.field && delete t.responsive,
                        t
                    });
                    var t = g.grep(g(p.table).find(".m-datatable__cell"), function(t, e) {
                        return a === g(t).data("field")
                ...
                destroyScroller: function(t) {
                    void 0 === t && (t = p.tableBody),
                    g(t).each(function() {
                        if (g(this).hasClass("mCustomScrollbar"))
                            try {
                ...
                row: function(t) {
                    return f.rows(t),
                    f.nodeTr = f.recentNode = g(f.nodeTr).first(),
                    p
                },
                rows: function(t) {
                    return f.nodeTr = f.recentNode = g(p.tableBody).find(t).filter(".m-datatable__row"),
                    p
                },
                column: function(t) {
                    return f.nodeCols = f.recentNode = g(p.tableBody).find(".m-datatable__cell:nth-child(" + (t + 1) + ")"),
                    p
                },
                columns: function(t) {
                    var e = p.table;
                    ...
                    return 0 < a.length ? f.nodeCols = f.recentNode = a : f.nodeCols = f.recentNode = g(e).find(t).filter(".m-datatable__cell"),
                    p
                },
                cell: function(t) {
                    return f.cells(t),
                    f.nodeTd = f.recentNode = g(f.nodeTd).first(),
                    p
                },
                cells: function(t) {
                    var e = g(p.tableBody).find(".m-datatable__cell");
                    return void 0 !== t && (e = g(e).filter(t)),
                    f.nodeTd = f.recentNode = e,
                    p
                },
                remove: function() {
                    return g(f.nodeTr.length) && f.nodeTr === f.recentNode && g(f.nodeTr).remove(),
                    f.layoutUpdate(),
                    p
                },
                visible: function(t) {
                    if (g(f.recentNode.length)) {
                        ...
                        t ? (f.recentNode === f.nodeCols && delete u.columns[a].responsive,
                        g(f.recentNode).show()) : (f.recentNode === f.nodeCols && f.setOption("columns." + a + ".responsive", {
                            hidden: "xl"
                        }),
                        g(f.recentNode).hide()),
                        f.redraw()
            ...
            void 0 !== u)
                if ("string" == typeof u) {
                    var t = u;
                    void 0 !== (p = g(this).data("mDatatable")) && (u = p.options,
                    f[t].apply(this, Array.prototype.slice.call(arguments, 1)))
                } else
                    p.data("mDatatable") || g(this).hasClass("m-datatable--loaded") || (p.dataSet = null,
                    p.textAlign = {
                        left: "m-datatable__cell--left",
                        center: "m-datatable__cell--center",
                        right: "m-datatable__cell--right"
                    },
                    u = g.extend(!0, {}, g.fn.mDatatable.defaults, u),
                    p.options = u,
                    f.init.apply(this, [u]),
                    g(p.wrap).data("mDatatable", p));
            else
                void 0 === (p = g(this).data("mDatatable")) && g.error("mDatatable not initialized"),
                u = p.options;
            return p
        }
        ...
        var a = {
          ...
          , l = {
            construct: function(t) {
                return mUtil.data(n).has("dropdown") ? o = mUtil.data(n).get("dropdown") : (l.init(t),
                l.setup(),
            ...
            show: function() {
                if ("hover" == o.options.toggle && mUtil.hasAttr(n, "hover"))
                    return l.clearHovered(),
                    o;
                if (o.open)
                    return o;
                if (o.layout.arrow && l.adjustArrowPos(),
            ...
            hide: function(t) {
                return !1 === o.open || (mUtil.isDesktopDevice() && "hover" == o.options.toggle ? l.hideHovered(t) : l.hideClicked(),
                "down" == o.layout.defaultDropPos && "up" == o.layout.currentDropPos && (mUtil.removeClass(n, "m-dropdown--up"),
            ...
            adjustArrowPos: function() {
                var t = mUtil.outerWidth(n)
                  ...
                  , a = 0;
                o.layout.arrow && (mUtil.isInResponsiveRange("mobile") && mUtil.hasClass(n, "m-dropdown--mobile-full-width") ? (a = mUtil.offset(n).left + t / 2 - Math.abs(parseInt(mUtil.css(o.layout.arrow, "width")) / 2) - parseInt(mUtil.css(o.layout.wrapper, "left")),
                mUtil.css(o.layout.arrow, "right", "auto"),
                mUtil.css(o.layout.arrow, "left", a + "px"),
                mUtil.css(o.layout.arrow, "margin-left", "auto"),
                mUtil.css(o.layout.arrow, "margin-right", "auto")) : mUtil.hasClass(o.layout.arrow, "m-dropdown__arrow--adjust") && (a = t / 2 - Math.abs(parseInt(mUtil.css(o.layout.arrow, "width")) / 2),
                mUtil.hasClass(n, "m-dropdown--align-push") && (a += 20),
                "right" == e ? (mUtil.css(o.layout.arrow, "left", "auto"),
                mUtil.css(o.layout.arrow, "right", a + "px")) : (mUtil.css(o.layout.arrow, "right", "auto"),
                mUtil.css(o.layout.arrow, "left", a + "px"))))
            },
            setZindex: function() {
                var t = 101
                ...
                t <= e && (t = e + 1),
                mUtil.css(o.layout.wrapper, "z-index", t)
            },
            ...
            eventTrigger: function(t, e) {
                for (var a = 0; a < o.events.length; a++) {
                    var n = o.events[a];
                    n.name == t && (1 == n.one ? 0 == n.fired && (o.events[a].fired = !0,
                    n.handler.call(this, o, e)) : n.handler.call(this, o, e))
                }
            },
...
var mHeader = function(t, e) {
    ...
    if (void 0 !== a) {
        var n = {
          ...
          , o = {
            construct: function(t) {
                return mUtil.data(a).has("header") ? i = mUtil.data(a).get("header") : (o.init(t),
                o.build(),
            ...
            build: function() {
                ...
                !1 === i.options.minimize.mobile && !1 === i.options.minimize.desktop || window.addEventListener("scroll", function() {
                    var t, e, a, n = 0;
                    mUtil.isInResponsiveRange("desktop") ? (n = i.options.offset.desktop,
                    t = i.options.minimize.desktop.on,
                    e = i.options.minimize.desktop.off) : mUtil.isInResponsiveRange("tablet-and-mobile") && (n = i.options.offset.mobile,
                    t = i.options.minimize.mobile.on,
                    e = i.options.minimize.mobile.off),
                    a = window.pageYOffset,
                    mUtil.isInResponsiveRange("tablet-and-mobile") && i.options.classic && i.options.classic.mobile || mUtil.isInResponsiveRange("desktop") && i.options.classic && i.options.classic.desktop ? n < a ? (mUtil.addClass(l, t),
                    mUtil.removeClass(l, e)) : (mUtil.addClass(l, e),
                    mUtil.removeClass(l, t)) : (n < a && o < a ? (mUtil.addClass(l, t),
                    mUtil.removeClass(l, e)) : (mUtil.addClass(l, e),
            ...
            eventTrigger: function(t, e) {
                for (var a = 0; a < i.events.length; a++) {
                    var n = i.events[a];
                    n.name == t && (1 == n.one ? 0 == n.fired && (i.events[a].fired = !0,
                    n.handler.call(this, i, e)) : n.handler.call(this, i, e))
                }
            },
            addEvent: function(t, e, a) {
                i.events.push({
  ...
  , mMenu = function(t, e) {
    ...
    if (d) {
        var n = {
          ...
          , f = {
            construct: function(t) {
                return mUtil.data(d).has("menu") ? p = mUtil.data(d).get("menu") : (f.init(t),
                f.reset(),
                f.build(),
                mUtil.data(d).set("menu", p)),
                p
            },
            init: function(t) {
                p.events = [],
            ...
            build: function() {
                ...
                ("dropdown" === f.getSubmenuMode() || f.isConditionalSubmenuDropdown()) && (p.eventHandlers.event_2 = mUtil.on(d, '[m-menu-submenu-toggle="hover"]', "mouseover", f.handleSubmenuDrodownHoverEnter),
                p.eventHandlers.event_3 = mUtil.on(d, '[m-menu-submenu-toggle="hover"]', "mouseout", f.handleSubmenuDrodownHoverExit),
                p.eventHandlers.event_4 = mUtil.on(d, '[m-menu-submenu-toggle="click"] > .m-menu__toggle, [m-menu-submenu-toggle="click"] > .m-menu__link .m-menu__toggle', "click", f.handleSubmenuDropdownClick),
                p.eventHandlers.event_5 = mUtil.on(d, '[m-menu-submenu-toggle="tab"] > .m-menu__toggle, [m-menu-submenu-toggle="tab"] > .m-menu__link .m-menu__toggle', "click", f.handleSubmenuDropdownTabClick)),
                p.eventHandlers.event_6 = mUtil.on(d, ".m-menu__item:not(.m-menu__item--submenu) > .m-menu__link:not(.m-menu__toggle):not(.m-menu__link--toggle-skip)", "click", f.handleLinkClick)
            },
            reset: function() {
            ...
            handleLinkClick: function(t) {
                ...
                ("dropdown" === f.getSubmenuMode() || f.isConditionalSubmenuDropdown()) && f.handleSubmenuDropdownClose(t, this)
            },
            handleSubmenuDrodownHoverEnter: function(t) {
                if ("accordion" !== f.getSubmenuMode() && !1 !== p.resumeDropdownHover()) {
                    var e = this;
                    "1" == e.getAttribute("data-hover") && (e.removeAttribute("data-hover"),
            ...
            handleSubmenuDropdownClick: function(t) {
                if ("accordion" !== f.getSubmenuMode()) {
                    ...
                    f.showSubmenuDropdown(e)) : (mUtil.removeClass(e, "m-menu__item--open-dropdown"),
                ...
                if ("accordion" !== f.getSubmenuMode()) {
                    ...
                    if (0 < a.length && !1 === mUtil.hasClass(e, "m-menu__toggle") && 0 === e.querySelectorAll(".m-menu__toggle").length)
                        for (var n = 0, o = a.length; n < o; n++)
                            f.hideSubmenuDropdown(a[0], !0)
                }
            },
            handleSubmenuAccordion: function(t, e) {
                var a, n = e || this;
                if ("dropdown" === f.getSubmenuMode() && (a = n.closest(".m-menu__item")) && "accordion" != a.getAttribute("m-menu-submenu-mode"))
                    t.preventDefault();
                else {
            ...
            adjustSubmenuDropdownArrowPos: function(t) {
                ...
                if (a) {
                    ...
                    mUtil.hasClass(e, "m-menu__submenu--pull") && (n += Math.abs(parseFloat(mUtil.css(e, "margin-right")))),
                    n = parseInt(mUtil.css(e, "width")) - n) : mUtil.hasClass(e, "m-menu__submenu--left") && (n = mUtil.outerWidth(t) / 2,
                    mUtil.hasClass(e, "m-menu__submenu--pull") && (n += Math.abs(parseFloat(mUtil.css(e, "margin-left"))))) : (mUtil.hasClass(e, "m-menu__submenu--center") || mUtil.hasClass(e, "m-menu__submenu--full")) && (n = mUtil.offset(t).left - (mUtil.getViewPort().width - parseInt(mUtil.css(e, "width"))) / 2,
            ...
            eventTrigger: function(t, e) {
                for (var a = 0; a < p.events.length; a++) {
                    var n = p.events[a];
                    n.name == t && (1 == n.one ? 0 == n.fired && (p.events[a].fired = !0,
                    n.handler.call(this, p, e)) : n.handler.call(this, p, e))
                }
            },
            addEvent: function(t, e, a) {
                p.events.push({
...
var mOffcanvas = function(t, e) {
    ...
    if (a) {
        var o = {}
          , i = {
            construct: function(t) {
                return mUtil.data(a).has("offcanvas") ? l = mUtil.data(a).get("offcanvas") : (i.init(t),
                i.build(),
                mUtil.data(a).set("offcanvas", l)),
                l
            },
            init: function(t) {
                l.events = [],
            ...
            build: function() {
                if (l.options.toggleBy)
                    if ("string" == typeof l.options.toggleBy)
                        mUtil.addEvent(l.options.toggleBy, "click", i.toggle);
                    else if (l.options.toggleBy && l.options.toggleBy[0] && l.options.toggleBy[0].target)
                        for (var t in l.options.toggleBy)
                            mUtil.addEvent(l.options.toggleBy[t].target, "click", i.toggle);
                    else
                        l.options.toggleBy && l.options.toggleBy.target && mUtil.addEvent(l.options.toggleBy.target, "click", i.toggle);
                var e = mUtil.get(l.options.closeBy);
                e && mUtil.addEvent(e, "click", i.hide)
            },
            toggle: function() {
                i.eventTrigger("toggle"),
                "shown" == l.state ? i.hide(this) : i.show(this)
            },
            show: function(e) {
                "shown" != l.state && (i.eventTrigger("beforeShow"),
                i.togglerClass(e, "show"),
                mUtil.addClass(n, l.classShown),
                mUtil.addClass(a, l.classShown),
                l.state = "shown",
                l.options.overlay && (l.overlay = mUtil.insertAfter(document.createElement("DIV"), a),
            ...
            hide: function(t) {
                "hidden" != l.state && (i.eventTrigger("beforeHide"),
            ...
            togglerClass: function(t, e) {
                ...
                if (l.options.toggleBy && l.options.toggleBy[0] && l.options.toggleBy[0].target)
                    for (var o in l.options.toggleBy)
                        l.options.toggleBy[o].target === n && (a = l.options.toggleBy[o]);
                else
                    l.options.toggleBy && l.options.toggleBy.target && (a = l.options.toggleBy);
                if (a) {
                    var i = mUtil.get(a.target);
                    "show" === e && mUtil.addClass(i, a.state),
                    "hide" === e && mUtil.removeClass(i, a.state)
                }
            },
            eventTrigger: function(t, e) {
                for (var a = 0; a < l.events.length; a++) {
                    var n = l.events[a];
                    n.name == t && (1 == n.one ? 0 == n.fired && (l.events[a].fired = !0,
                    n.handler.call(this, l, e)) : n.handler.call(this, l, e))
                }
            },
            addEvent: function(t, e, a) {
                l.events.push({
  ...
  , mPortlet = function(t, e) {
    ...
    if (d) {
        var a = {
          ...
          , o = {
            construct: function(t) {
                return mUtil.data(d).has("portlet") ? s = mUtil.data(d).get("portlet") : (o.init(t),
                o.build(),
                mUtil.data(d).set("portlet", s)),
                s
            },
            init: function(t) {
                s.element = d,
                s.events = [],
                s.options = mUtil.deepExtend({}, a, t),
                s.head = mUtil.child(d, ".m-portlet__head"),
                s.foot = mUtil.child(d, ".m-portlet__foot"),
                mUtil.child(d, ".m-portlet__body") ? s.body = mUtil.child(d, ".m-portlet__body") : 0 !== mUtil.child(d, ".m-form").length && (s.body = mUtil.child(d, ".m-form"))
            },
            build: function() {
            ...
            remove: function() {
                !1 !== o.eventTrigger("beforeRemove") && (mUtil.hasClass(c, "m-portlet--fullscreen") && mUtil.hasClass(d, "m-portlet--fullscreen") && o.fullscreen("off"),
                o.removeTooltips(),
                mUtil.remove(d),
            ...
            expand: function() {
                if (!1 !== o.eventTrigger("beforeExpand")) {
                    ...
                    mUtil.removeClass(d, "m-portlet--collapse"),
                    mUtil.removeClass(d, "m-portlet--collapsed");
                    var t = mUtil.find(s.head, "[m-portlet-tool=toggle]");
                    t && mUtil.data(t).has("tooltip") && mUtil.data(t).get("tooltip").updateTitleContent(s.options.tools.toggle.collapse)
                }
            },
            fullscreen: function(t) {
                if ("off" === t || mUtil.hasClass(c, "m-portlet--fullscreen") && mUtil.hasClass(d, "m-portlet--fullscreen"))
                    o.eventTrigger("beforeFullscreenOff"),
                    mUtil.removeClass(c, "m-portlet--fullscreen"),
                    mUtil.removeClass(d, "m-portlet--fullscreen"),
                    o.removeTooltips(),
                    o.setupTooltips(),
                    s.foot && (mUtil.css(s.body, "margin-bottom", ""),
                    mUtil.css(s.foot, "margin-top", "")),
                    o.eventTrigger("afterFullscreenOff");
                else {
                    if (o.eventTrigger("beforeFullscreenOn"),
                    mUtil.addClass(d, "m-portlet--fullscreen"),
                    mUtil.addClass(c, "m-portlet--fullscreen"),
                    o.removeTooltips(),
                    o.setupTooltips(),
                    s.foot) {
                        var e = parseInt(mUtil.css(s.foot, "height"))
                          , a = parseInt(mUtil.css(s.foot, "height")) + parseInt(mUtil.css(s.head, "height"));
                        mUtil.css(s.body, "margin-bottom", e + "px"),
                        mUtil.css(s.foot, "margin-top", "-" + a + "px")
                    }
            ...
            eventTrigger: function(t) {
                for (i = 0; i < s.events.length; i++) {
                    var e = s.events[i];
                    e.name == t && (1 == e.one ? 0 == e.fired && (s.events[i].fired = !0,
                    e.handler.call(this, s)) : e.handler.call(this, s))
                }
            },
            addEvent: function(t, e, a) {
  ...
  , mQuicksearch = function(t, e) {
    ...
    if (a) {
        var l = {
          ...
          , r = {
            construct: function(t) {
                return mUtil.data(a).has("quicksearch") ? n = mUtil.data(a).get("quicksearch") : (r.init(t),
                r.build(),
            ...
            init: function(t) {
                ...
                "default" == n.options.mode && (n.iconSearch = mUtil.get(n.options.iconSearchTarget),
                n.iconCancel = mUtil.get(n.options.iconCancelTarget)),
            ...
            build: function() {
                ...
                "default" == n.options.mode ? (mUtil.addEvent(n.input, "focus", r.showDropdown),
                mUtil.addEvent(n.iconCancel, "click", r.handleCancel),
            ...
            search: function(t) {
                if (n.query = n.input.value,
                0 === n.query.length && (r.handleCancelIconVisibility("on"),
                mUtil.removeClass(a, n.options.hasResultClass),
                mUtil.removeClass(n.form, n.options.spinnerClass)),
                !(n.query.length < n.options.minLength || 1 == n.processing))
                    return n.requestTimeout && clearTimeout(n.requestTimeout),
                    n.requestTimeout = !1,
            ...
            handleCancelIconVisibility: function(t) {
                "on" == t ? 0 === n.input.value.length ? (n.iconCancel && mUtil.css(n.iconCancel, "visibility", "hidden"),
                n.iconClose && mUtil.css(n.iconClose, "visibility", "visible")) : (clearTimeout(n.cancelTimeout),
                n.cancelTimeout = setTimeout(function() {
                    n.iconCancel && mUtil.css(n.iconCancel, "visibility", "visible"),
                    n.iconClose && mUtil.css(n.iconClose, "visibility", "visible")
                }, 500)) : (n.iconCancel && mUtil.css(n.iconCancel, "visibility", "hidden"),
                n.iconClose && mUtil.css(n.iconClose, "visibility", "hidden"))
            },
            ...
            showDropdown: function(t) {
                0 == n.dropdown.isShown() && n.input.value.length > n.options.minLength && 0 == n.processing && (console.log("show!!!"),
                n.dropdown.show(),
                t && (t.preventDefault(),
                t.stopPropagation()))
            },
            eventTrigger: function(t) {
                for (i = 0; i < n.events.length; i++) {
                    var e = n.events[i];
                    e.name == t && (1 == e.one ? 0 == e.fired && (n.events[i].fired = !0,
                    e.handler.call(this, n)) : e.handler.call(this, n))
                }
            },
            addEvent: function(t, e, a) {
        ...
        n.showResult = function(t) {
            return n.dropdown.setContent(t),
            r.showDropdown(),
            n
        }
        ,
        n.showError = function(t) {
            ...
            return n.dropdown.setContent(e),
            r.showDropdown(),
            n
        }
        ,
  ...
  , mScrollTop = function(t, e) {
    ...
    if (a) {
        var i = {
          ...
          , l = {
            construct: function(t) {
                return mUtil.data(a).has("scrolltop") ? o = mUtil.data(a).get("scrolltop") : (l.init(t),
                l.build(),
            ...
            scroll: function(t) {
                t.preventDefault(),
                mUtil.scrollTop(o.options.speed)
            },
            eventTrigger: function(t, e) {
                for (var a = 0; a < o.events.length; a++) {
                    var n = o.events[a];
  ...
  , mToggle = function(t, e) {
    ...
    if (a) {
        var o = {
          ...
          , l = {
            construct: function(t) {
                return mUtil.data(a).has("toggle") ? n = mUtil.data(a).get("toggle") : (l.init(t),
                l.build(),
            ...
            toggle: function() {
                return "off" == n.state ? l.toggleOn() : l.toggleOff(),
                n
            },
            toggleOn: function() {
            ...
            toggleOff: function() {
                ...
                n.togglerState && mUtil.removeClass(a, n.togglerState),
                n.state = "off",
  ...
  , mWizard = function(t, e) {
    ...
    if (o) {
        var a = {
          ...
          , r = {
            construct: function(t) {
                return mUtil.data(o).has("wizard") ? l = mUtil.data(o).get("wizard") : (r.init(t),
                r.build(),
                mUtil.data(o).set("wizard", l)),
                l
            },
            init: function(t) {
                l.element = o,
                ...
                l.steps = mUtil.findAll(o, ".m-wizard__step"),
                l.progress = mUtil.find(o, ".m-wizard__progress .progress-bar"),
                l.btnSubmit = mUtil.find(o, '[data-wizard-action="submit"]'),
                l.btnNext = mUtil.find(o, '[data-wizard-action="next"]'),
                l.btnPrev = mUtil.find(o, '[data-wizard-action="prev"]'),
                l.btnLast = mUtil.find(o, '[data-wizard-action="last"]'),
                l.btnFirst = mUtil.find(o, '[data-wizard-action="first"]'),
                l.events = [],
                l.currentStep = 1,
                l.stop = !1,
                l.totalSteps = l.steps.length,
                1 < l.options.startStep && r.goTo(l.options.startStep),
                r.updateUI()
            },
            build: function() {
            ...
            goTo: function(t) {
                if (t !== l.currentStep) {
                    var e;
                    if (e = (t = t ? parseInt(t) : r.getNextStep()) > l.currentStep ? r.eventTrigger("beforeNext") : r.eventTrigger("beforePrev"),
                    !0 !== l.stop)
                        return !1 !== e && (l.currentStep = t,
                        r.updateUI(),
                        r.eventTrigger("change")),
                        t > l.startStep ? r.eventTrigger("afterNext") : r.eventTrigger("afterPrev"),
                        l;
                    l.stop = !1
                }
            },
            setStepClass: function() {
                r.isLastStep() ? mUtil.addClass(o, "m-wizard--step-last") : mUtil.removeClass(o, "m-wizard--step-last"),
                r.isFirstStep() ? mUtil.addClass(o, "m-wizard--step-first") : mUtil.removeClass(o, "m-wizard--step-first"),
                r.isBetweenStep() ? mUtil.addClass(o, "m-wizard--step-between") : mUtil.removeClass(o, "m-wizard--step-between")
            },
            updateUI: function(t) {
                r.updateProgress(),
                r.handleTarget(),
                ...
                for (var e = 0, a = l.steps.length; e < a; e++)
                    mUtil.removeClass(l.steps[e], "m-wizard__step--current m-wizard__step--done");
                for (e = 1; e < l.currentStep; e++)
                    mUtil.addClass(l.steps[e - 1], "m-wizard__step--done");
            ...
            handleTarget: function() {
                ...
                mUtil.removeClass(a, "m-wizard__form-step--current"),
            ...
            eventTrigger: function(t) {
                for (i = 0; i < l.events.length; i++) {
                    var e = l.events[i];
                    e.name == t && (1 == e.one ? 0 == e.fired && (l.events[i].fired = !0,
                    e.handler.call(this, l)) : e.handler.call(this, l))
                }
            },
            addEvent: function(t, e, a) {
...
Chart.elements.Rectangle.prototype.draw = function() {
    var t, e, a, n, o, i, l, r = this._chart.ctx, s = this._view, d = s.borderWidth, c = this._chart.options.barRadius ? this._chart.options.barRadius : 0;
    if (s.horizontal ? (t = s.base,
    e = s.x,
    a = s.y - s.height / 2,
    n = s.y + s.height / 2,
    o = t < e ? 1 : -1,
    i = 1,
    l = s.borderSkipped || "left") : (t = s.x - s.width / 2,
    e = s.x + s.width / 2,
    o = 1,
    i = (a = s.y > 2 * c ? s.y - c : s.y) < (n = s.base) ? 1 : -1,
    l = s.borderSkipped || "bottom"),
    d) {
    ...
    for (var U = 1; U < 4; U++) {
        ...
        nextCorner = _(nextCornerId),
        width = b[2][0] - b[1][0],
        height = b[0][1] - b[1][1],
        x = b[1][0],
        y = b[1][1],
        (C = c) > height / 2 && (C = height / 2),
        C > width / 2 && (C = width / 2),
        r.moveTo(x + C, y),
        r.lineTo(x + width - C, y),
        r.quadraticCurveTo(x + width, y, x + width, y + C),
        r.lineTo(x + width, y + height - C),
        r.quadraticCurveTo(x + width, y + height, x + width - C, y + height),
        r.lineTo(x + C, y + height),
        r.quadraticCurveTo(x, y + height, x, y + height - C),
        r.lineTo(x, y + C),
        r.quadraticCurveTo(x, y, x + C, y)
    }
    r.fill(),
    d && r.stroke()
}
...
jQuery.validator.setDefaults({
    ...
    success: function(t, e) {
        ...
        a.find(".form-control-feedback").remove()
    }
}),
...
function(l) {
    ...
    l.fn.mDatatable.checkbox = function(n, o) {
        var i = {
            ...
            unselectedRows: [],
            init: function() {
                i.selectorEnabled() && (o.vars.requestIds && n.setDataSourceParam(o.vars.requestIds, !0),
                i.selectedAllRows = n.getDataSourceParam(o.vars.selectedAllRows),
                l(n).on("m-datatable--on-layout-updated", function(t, e) {
            ...
            initEvent: function() {
                l(n.tableHead).find('.m-checkbox--all > [type="checkbox"]').click(function(t) {
                    if (i.selectedRows = i.unselectedRows = [],
                    n.stateRemove("checkbox"),
                    l(this).is(":checked") ? i.selectedAllRows = !0 : i.selectedAllRows = !1,
                    !o.vars.requestIds) {
                        l(this).is(":checked") && (i.selectedRows = l.makeArray(l(n.tableBody).find('.m-checkbox--single > [type="checkbox"]').map(function(t, e) {
                            return l(e).val()
                        })));
                        var e = {};
                        e.selectedRows = l.unique(i.selectedRows),
                        n.stateKeep("checkbox", e)
                    }
                    n.setDataSourceParam(o.vars.selectedAllRows, i.selectedAllRows),
                    l(n).trigger("m-datatable--on-click-checkbox", [l(this)])
                }),
                l(n.tableBody).find('.m-checkbox--single > [type="checkbox"]').click(function(t) {
                    var e = l(this).val();
                    l(this).is(":checked") ? (i.selectedRows.push(e),
                    i.unselectedRows = i.remove(i.unselectedRows, e)) : (i.unselectedRows.push(e),
                    i.selectedRows = i.remove(i.selectedRows, e)),
                    !o.vars.requestIds && i.selectedRows.length < 1 && l(n.tableHead).find('.m-checkbox--all > [type="checkbox"]').prop("checked", !1);
                    var a = {};
                    a.selectedRows = l.unique(i.selectedRows),
                    a.unselectedRows = l.unique(i.unselectedRows),
                    n.stateKeep("checkbox", a),
                    l(n).trigger("m-datatable--on-click-checkbox", [l(this)])
                })
            },
            initSelect: function() {
                i.selectedAllRows && o.vars.requestIds ? (n.hasClass("m-datatable--error") || l(n.tableHead).find('.m-checkbox--all > [type="checkbox"]').prop("checked", !0),
                n.setActiveAll(!0),
                i.unselectedRows.forEach(function(t) {
                    n.setInactive(t)
            ...
            initVars: function() {
                ...
                void 0 !== t && (i.selectedRows = t.selectedRows || [],
                i.unselectedRows = t.unselectedRows || [])
            },
            getSelectedId: function(t) {
                if (i.initVars(),
                i.selectedAllRows && o.vars.requestIds) {
        ...
        ,
        "object" == typeof o && (o = l.extend(!0, {}, l.fn.mDatatable.checkbox.default, o),
        i.init.apply(this, [o])),
        n
    }
    ,
...
var mLayout = function() {
    ...
    return {
        ...
        initHeader: function() {
            ...
            "hide" == mUtil.attr(e, "m-minimize-mobile") ? (a.minimize.mobile = {},
            a.minimize.mobile.on = "m-header--hide",
            a.minimize.mobile.off = "m-header--show") : a.minimize.mobile = !1,
            "hide" == mUtil.attr(e, "m-minimize") ? (a.minimize.desktop = {},
            a.minimize.desktop.on = "m-header--hide",
            a.minimize.desktop.off = "m-header--show") : a.minimize.desktop = !1,
