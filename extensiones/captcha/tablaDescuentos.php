...
require_once "../../modelo/conexion.php";
 ...
 $db = new Conexion();                                             
            ...
            $sql = $db->consulta("SELECT vtama_tipo_descuento.cod_tipo_descuento, vtama_tipo_descuento.dsc_tipo_descuento, vtama_tipo_descuento.flg_precio_libre, vtama_tipo_descuento.flg_periodo_carencia
              ...
              WHERE flg_activo = 'SI' 
              AND CONVERT(DATE,vtade_tipo_descuento.fch_inicio,21) <= CONVERT(DATE, '13/10/2019',21)
              AND  CONVERT(DATE,vtade_tipo_descuento.fch_fin,21) >= CONVERT(DATE, '13/06/2019',21)");
