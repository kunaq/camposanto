...
class ModeloWizard{
	...
	static public function mdlGetDatosContrato($cod_localidad,$cod_contrato){
		$db = new Conexion();
		$sql = $db->consulta("SELECT TOP 1 vtade_contrato.cod_contrato, vtade_contrato.cod_tipo_programa, vtade_contrato.cod_tipo_ctt, (SELECT TOP 1 vtama_cliente.dsc_documento FROM vtama_cliente WHERE vtama_cliente.cod_cliente = vtade_contrato.cod_cliente) AS dsc_documento, vtaca_contrato.cod_camposanto_actual, (SELECT TOP 1 vtama_plataforma.cod_tipo_plataforma FROM vtama_plataforma WHERE vtama_plataforma.cod_camposanto = vtaca_contrato.cod_camposanto_actual AND vtama_plataforma.cod_plataforma = vtaca_contrato.cod_plataforma_actual) AS cod_tipo_plataforma, vtaca_contrato.cod_plataforma_actual, vtaca_contrato.cod_areaplataforma_actual, vtaca_contrato.cod_ejehorizontal_actual, vtaca_contrato.cod_ejevertical_actual, vtaca_contrato.cod_espacio_actual,(SELECT TOP 1 vtaca_espacio.cod_tipo_espacio FROM vtaca_espacio WHERE vtaca_espacio.cod_camposanto = vtaca_contrato.cod_camposanto_actual AND vtaca_espacio.cod_plataforma = vtaca_contrato.cod_plataforma_actual AND cod_area_plataforma = vtaca_contrato.cod_areaplataforma_actual AND cod_eje_horizontal = vtaca_contrato.cod_ejehorizontal_actual AND cod_eje_vertical = vtaca_contrato.cod_ejevertical_actual) AS cod_tipo_espacio_actual,(SELECT TOP 1 vtaca_espacio.cod_estado FROM vtaca_espacio WHERE vtaca_espacio.cod_camposanto = vtaca_contrato.cod_camposanto_actual AND vtaca_espacio.cod_plataforma = vtaca_contrato.cod_plataforma_actual AND cod_area_plataforma = vtaca_contrato.cod_areaplataforma_actual AND cod_eje_horizontal = vtaca_contrato.cod_ejehorizontal_actual AND cod_eje_vertical = vtaca_contrato.cod_ejevertical_actual) AS cod_estado_actual FROM vtade_contrato INNER JOIN vtaca_contrato ON vtaca_contrato.cod_contrato = vtade_contrato.cod_contrato WHERE vtade_contrato.cod_localidad = '$cod_localidad' AND vtade_contrato.cod_contrato  LIKE (RIGHT('0000000000'+'$cod_contrato',10))");
